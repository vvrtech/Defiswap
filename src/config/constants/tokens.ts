...
export const mainnetTokens = defineTokens({
  ...
  syrup: new Token(
    MAINNET,
    '0x5336081b414AA6290EE9057275E03658ffD17E9B',
    18,
    'SYRUP',
    'SyrupBar Token',
    'https://pancakeswap.finance/',
...
export const testnetTokens = defineTokens({
  ...
  // gmi: new Token(TESTNET, '0x93D8d25E3C9A847a5Da79F79ecaC89461FEcA846', 18, 'GMI', 'Gamifi', 'https://gamifi.gg/'),
  // tlos: new Token(TESTNET, '0xb6C53431608E626AC81a9776ac3e999c5556717c', 18, 'TLOS', 'Telos', 'https://www.telos.net/'),
  alpaca: new Token(
    TESTNET,
    '0x4e082EbE4c3B4A5B4FdE3E518B797a5BFC2F161d',
    18,
    'ALPCA',
    'Alpca',
    'https://betafinance.org',
  ...
  tokoCrypt: new Token(
    TESTNET,
    '0x28675cE166F7d0B224E81468744F5f14a0f588D7',
    18,
    'TKO',
    'TokoCrypto',
    'https://betafinance.org',
  ),
  nerveFinance: new Token(
    TESTNET,
    '0x485f8329F2800534Ed58AF30C01A5EEd5A21b3EA',
    18,
    'NRV',
    'NerveFincance',
    'https://betafinance.org',
  ...
  defc: new Token(
    ...
    // nft: new Token(TESTNET, '0x1fC9004eC7E5722891f5f38baE7678efCB11d34D', 6, 'NFT', 'APENFT', 'https://apenft.org'),
  // stephero: new Token(
  //   TESTNET,
  //   '0xE8176d414560cFE1Bf82Fd73B986823B89E4F545',
  //   18,
  ...
  //   'https://stephero.io/',
  // ),
  // pros: new Token(TESTNET, '0xEd8c8Aa8299C10f067496BB66f8cC7Fb338A3405', 18, 'PROS', 'Prosper', 'https://prosper.so/'),
  // qbt: new Token(TESTNET, '0x17B7163cf1Dbd286E262ddc68b553D899B93f526', 18, 'QBT', 'Qubit Token', 'https://qbt.fi/'),
  // cvp: new Token(
  //   TESTNET,
  //   '0x5Ec3AdBDae549Dce842e24480Eb2434769e22B2E',
  //   18,
