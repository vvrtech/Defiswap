        ...
        <StyledTokenContent justifyContent="space-between" alignItems="center">
          <Box ml="8px">
            ...
            <Text color="textSubtle" fontSize="14px">
              {t('Stake DEFC to participate in IFO')}
            </Text>
          </Box>
      ...
      <StyledCardBody>
        <Message variant="warning" mb="37px">
          <Flex flexDirection="column">
            <Text mb="16px">
              {t(
                'This is the old IFO DEFC pool. Check out the brand new DEFC pool to learn how to earn DEFC rewards with higher APY while enjoying other benefits.',
              )}
            </Text>
            <Flex ml="-34px">
              <Button onClick={handleOnClick} width="100%">
                {isShowMigrationButton ? t('Migrate') : t('Go to new DEFC pool')}
              </Button>
            </Flex>
          </Flex>
        </Message>
        ...
        <Box mt="24px">
          <Flex alignItems="center" justifyContent="space-between">
            <Text fontSize="14px">{`${t('Recent DEFC profit')}:`}</Text>
            <Balance
              bold
              fontSize="14px"
