...
const ContributeModal: React.FC<Props> = ({
  ...
  const label = currency === tokens.cake ? t('Max. DEFC entry') : t('Max. token entry')
      ...
      <ModalBody maxWidth="360px">
        ...
        <Box p="2px">
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough DEFC, you may not receive any IFO tokens at all and will only receive a full refund of your DEFC.',
            )}
            <Link
              fontSize="12px"
              display="inline"
              href="https://docs.defiswap.io/products/ifo-initial-farm-offering"
              external
            >
              {t('Read more')}
            </Link>
