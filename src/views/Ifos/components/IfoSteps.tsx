...
const Step1 = () => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <Box>
      ...
      <InlineLink
        external
        href="https://docs.defiswap.io/products/ifo-initial-farm-offering/icake"
      >
    ...
    <CardBody>
      ...
      <Box>
        <Text color="textSubtle" small>
          {t(
            'The maximum amount of DEFC user can commit to the Public Sale, is equal to the average DEFC balance in the IFO DEFC pool prior to the IFO. Stake more DEFC to increase the maximum DEFC you can commit to the sale. Missed this IFO? You can keep staking in the IFO DEFC Pool to join the next IFO sale.',
          )}
        </Text>
...
const Step2 = () => {
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t('When the IFO sales are live, you can “commit” your DEFC to buy the tokens being sold.')} <br />
      </Text>
    </CardBody>
  )
}
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active Defiswap Profile to take part in an IFO!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent DEFC tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
