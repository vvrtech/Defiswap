...
describe('limitOrders/utils/getPriceForOneToken', () => {
  describe.each([
    [new TokenAmount(DEFC, ONE), new TokenAmount(BUSD, ONE), '1'],
    [new TokenAmount(DEFC, FIVE), new TokenAmount(BUSD, FIVE), '1'],
    [new TokenAmount(DEFC, ONE), new TokenAmount(BUSD, FIVE), '5'],
    [new TokenAmount(DEFC, FIVE), new TokenAmount(BUSD, ONE), '0.2'],
    ...
    [new TokenAmount(DEFC, ZERO), new TokenAmount(BUSD, ONE), undefined],
    [new TokenAmount(DEFC, ONE), new TokenAmount(BUSD, ZERO), undefined],
