              ...
              <ColumnCenter>
                <Message variant="warning">
                  <div>
                    ...
                    <Text color="#ffffff" mb="8px">{t('The ratio of tokens you add will set the price of this pool.')}</Text>
                    <Text color="#ffffff">{t('Once you are happy with the rate click supply to review.')}</Text>
                  </div>
                </Message>
              </ColumnCenter>
            )}
