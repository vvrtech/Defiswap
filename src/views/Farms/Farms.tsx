...
background-image:url('/images/farms/ezgif.com-gif-maker.gif');
background-repeat:no-repeat;
background-size:cover;

@media screen and (max-width: 1300px) {
    background-image:url('/images/farms/ezgif.com-gif-maker1.gif');
}
@media screen and (max-width: 1300px) {
  background-image:url('/images/farms/ezgif.com-gif-maker2.gif');
}
`
  ...
  return (
    <FarmsContext.Provider value={{ chosenFarmsMemoized }}>
      ...
      <Page>
        ...
        <div ref={observerRef} />
        <StyledImage src="/images/home/PAGE_ITEMS/DeFi-Swap-Coin-Design.png" alt="Pancake illustration" width={120} height={123} />
      </Page>
