  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active DefiSwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold DEFC'),
      bodyText: [t('Each NFT costs DEFC to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
