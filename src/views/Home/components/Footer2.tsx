...
import { Flex, Heading, Text, Link, useMatchBreakpointsContext, Button, useWalletModal } from '@pancakeswap/uikit'
    ...
    <div>
      <Wrapper>
        <div style={{ display: !matches2 ? "flex" : "none", justifyContent: "center", alignItems: "center" }} >
          <Lottie loop={true} animationData={rocket} style={{ height: matches2 ? "85%" : "100%", width: matches2 ? "23%" : !matches2 && matches6 ? "50%" : "100%" }} />
        </div>
