...
export default function Swap() {
  ...
  return (
    <Page removePadding={isChartExpanded} hideFooterOnDesktop={isChartExpanded}>
      <Flex flexDirection="row-reverse" width="100%" justifyContent="center" position="relative">
        {!isMobile && (
          <PriceChartContainer
          ...
          <StyledSwapContainer $isChartExpanded={isChartExpanded}>
            <StyledInputCurrencyWrapper mt={isChartExpanded ? '24px' : '0'}>
              <AppBody>
                ...
                />
                <Wrapper id="swap-page" style={{ minHeight: '412px', backgroundColor: "#37aa3d"  }}>
                  <AutoColumn gap="sm">
                    <CurrencyInputPanel
                      label={
                    ...
                    {showWrap ? null : (
                      <AutoColumn gap="7px" style={{ padding: '0 16px' }}>
                        <RowBetween align="center">
                          {Boolean(trade) && (
                            <>
                              <Label style={{ color: "#372F47" }}>{t('Price')}</Label>
                              {isLoading ? (
                        ...
                        <RowBetween align="center">
                          <Label style={{ color: "#372F47" }}>{t('Slippage Tolerance')}</Label>
                  ...
                  <Box mt="0.25rem">
                    {swapIsUnsupported ? (
                      ...
                      <ConnectWalletButton width="100%" style={{ backgroundColor: "#082a45" }}/>
                    ) : showWrap ? (
