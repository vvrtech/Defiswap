          ...
          <CardBody>
            <AutoColumn gap="16px">
                ...
                <RowFixed>
                  <Flex flexDirection="column" alignItems="flex-end">
                    ...
                    {Number.isFinite(totalUSDValue) && (
                      <Text small color="white">{`(~${totalUSDValue.toLocaleString(undefined, {
              ...
              <AutoColumn gap="4px">
                {poolData && (
                  <FixedHeightRow>
                    <TooltipText ref={targetRef} color="white" small>
                      {t('LP reward APR')}:
                    </TooltipText>
                    {tooltipVisible && tooltip}
                    <Text color='white'>{formatAmount(poolData.lpApr7d)}%</Text>
                  </FixedHeightRow>
                )}
                <FixedHeightRow>
                  ...
                  <Text color="white">{poolTokenPercentage ? `${poolTokenPercentage.toFixed(6)}%` : '-'}</Text>
                </FixedHeightRow>
                <FixedHeightRow>
                  <Text color="white" small>
